...
export const getCustomerDaily = async (rider_id) => {
    const response = await fetch(`${API_URL}/api/get/customer/rider/${rider_id}`, {
        method: 'GET',
        headers: {
...
export const getCustomer = async(riderId) => {
    const response = await fetch(`${API_URL}/api/get/customer/rider/${riderId}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
        },
...
export const registerCustomer = async(userData) => {
    try {
        const response = await fetch(`${API_URL}/api/register/customer/rider`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
